...
export default function About() {
  return (
    <section>
      <div className="flex flex-col max-w-6xl h-screen justify-center mx-auto text-left">
        <div className="absolute max-w-2xl text-white">
          <h2 className="text-9xl tracking-wide font-semibold">About Me</h2>
          ...
          <ul className="text-sm font-firacode mt-3 grid grid-cols-3 max-w-md">
            <li>Javascript</li>
            <li>React</li>
            <li>Node.js</li>
            <li>Express</li>
